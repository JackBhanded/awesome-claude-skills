...
- [Claude Meter](https://github.com/JackBhanded/claude-meter) - Windows taskbar widget showing your live Claude usage from claude.ai/settings/usage — per-model breakdown, reset countdowns, single .exe.
